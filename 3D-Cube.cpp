...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
       ...
       // tableMatrix = glm::rotate(tableMatrix, glm::radians(rotateAngle_X), glm::vec3(1.0f, 0.0f, 0.0f));
       // tableMatrix = glm::rotate(tableMatrix, glm::radians(rotateAngle_Y), glm::vec3(0.0f, 1.0f, 0.0f));
        //tableMatrix = glm::rotate(tableMatrix, glm::radians(rotateAngle_Z), glm::vec3(0.0f, 0.0f, 1.0f));
        // render boxes
